...
public class PersonCeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_person_ce);
        ...
        if(cnt > 0){
            ...
            textView2.setText("Chief Engineer Signature");
    ...
    public void display(){
        int cnt = db.GetCount("person_ce", " WHERE person_id = '"+person_id+"'");
        ...
        if(cnt > 0){
            List<PersonCe> list = db.getPersonCe(person_id);
            for (PersonCe list1 : list){
