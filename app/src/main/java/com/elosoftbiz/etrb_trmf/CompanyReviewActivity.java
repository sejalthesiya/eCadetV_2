...
public class CompanyReviewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(cnt > 0){
            if(dept.equals("DECK")){
                tv_instruct.setText(getString(R.string.company_review_deck));
            }else{
                tv_instruct.setText(getString(R.string.company_review_engine));
            }
            //CHANGE MENU HERE
            if(dept.equals("DECK")){
    ...
    private class generate extends AsyncTask<Void, Void, Void>
    {
        ...
        {
            super.onPreExecute();
            pd = new ProgressDialog(CompanyReviewActivity.this);
    ...
    public void display(){
        int cnt = db.GetCount("person_inspect", "");
        ...
        LinearLayout linearLayout = new LinearLayout(CompanyReviewActivity.this);
        linearLayout.setLayoutParams(layoutParams);
        ...
        textView1.post(new Runnable() {
            @Override
            public void run() {
                int height = textView1.getLineCount() * textView4.getMeasuredHeight();
                ...
                LinearLayout.LayoutParams params2 = (LinearLayout.LayoutParams) textView4.getLayoutParams();
        ...
        if(cnt > 0){
            ...
            for(PersonInspect personInspect : personInspects){
                ...
                LinearLayout linearLayout1 = new LinearLayout(CompanyReviewActivity.this);
                linearLayout1.setLayoutParams(layoutParams1);
                linearLayout1.setBackgroundResource(R.drawable.border1dp);

                TextView textView_ = new TextView(CompanyReviewActivity.this);
                textView_.setText(personInspect.getComments());
                textView_.setTextSize(15);
                textView_.setTextColor(Color.BLACK);
                textView_.setLayoutParams(layoutParams3);
                textView_.setPadding(5,5,5,5);
                linearLayout1.addView(textView_);

                String lname = db.getFieldString("lname", " login_id = '"+personInspect.getChecked_by_id()+"'", "login");
                String fname = db.getFieldString("fname", " login_id = '"+personInspect.getChecked_by_id()+"'", "login");

                TextView textView1_ = new TextView(CompanyReviewActivity.this);
                textView1_.setText(lname + ", " + fname);
                ...
                String designation = db.getFieldString("designation", " login_id = '"+personInspect.getChecked_by_id()+"'", "login");

                TextView textView2_ = new TextView(CompanyReviewActivity.this);
                textView2_.setText(designation);
                ...
                TextView textView3_ = new TextView(CompanyReviewActivity.this);
                textView3_.setText(personInspect.getDate_checked());
    ...
    public void onBackPressed() {
        Intent intent = new Intent(CompanyReviewActivity.this, MainActivity.class);
