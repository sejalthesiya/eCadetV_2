...
public class StoReviewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sto_review);
        ...
        if(cnt > 0){
            ...
            textView2.setText("OTS Signature");
    ...
    private class generate extends AsyncTask<Void, Void, Void>
    {
        ...
        {
            super.onPreExecute();
            pd = new ProgressDialog(StoReviewActivity.this);
    ...
    public void display(){
        int cnt = db.GetCount("person_to", " WHERE person_id = '"+person_id+"'");
        ...
        if(cnt > 0){
            List<PersonTo> list = db.getPersonTo(person_id);
            for (PersonTo list1 : list){
                linearLayout = new LinearLayout(this);
                linearLayout.setLayoutParams(layoutParams);
                ...
                String comments = URLDecoder.decode(list1.getChecked_remarks());
                ...
                String date_checked = list1.getDate_signed();
