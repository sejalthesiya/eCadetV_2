...
public class MenuEngine extends Activity {
    NavigationView navigationView;
    ProgressDialog pd;
    DatabaseHelper db;

    public MenuEngine(NavigationView navigationView, final Context context, final DrawerLayout mDrawerLayout){
            ...
            public boolean onNavigationItemSelected(MenuItem item) {
                switch (item.getItemId()){
                    ...
                    case R.id.nav_crew_list:
                        ...
                        ((Activity)context).finish();
                        break;
                    case R.id.nav_person_ce:
                        Intent person_inspect = new Intent(context, PersonCeActivity.class);
                    ...
                    case R.id.nav_person_emergancy:
                        Toast.makeText(context, "Currently not yet available", Toast.LENGTH_LONG).show();
                        break;
                    ...
                    case R.id.nav_person_journal_engine:
                        Intent watchkeeping = new Intent(context, PortWatchesActivity.class);
                    ...
                    case R.id.nav_person_project_work:
                        Toast.makeText(context, "Will be available soon.", Toast.LENGTH_LONG).show();
                        break;
