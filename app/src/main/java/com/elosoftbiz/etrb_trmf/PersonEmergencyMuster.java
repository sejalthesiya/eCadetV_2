...
public class PersonEmergencyMuster {
    Integer id;
    String person_emergency_muster_id;
    String person_id;
    String vessel_id;
    ...
    public PersonEmergencyMuster(Integer id, String person_emergency_muster_id, String person_id, String vessel_id, String date_familiarization, String details, String filename, String checked_by_id, String date_checked, String checked_remarks){
        this.id = id;
        this.person_emergency_muster_id = person_emergency_muster_id;
    ...
    public String getPerson_emergency_muster_id() {
        return person_emergency_muster_id;
    }

    public void setPerson_emergency_muster_id(String person_emergency_muster_id) {
        this.person_emergency_muster_id = person_emergency_muster_id;
    }
